...
public class SujetDaoImpl implements SujetDao {
	...
	private static final String SQL_SELECT_PAR_NOM = "SELECT * FROM Utilisateur WHERE nom = ?";
	private static final String SQL_INSERT = "INSERT INTO Sujet (nom, dateCreation, auteur) VALUES (?, NOW(), ?)";
	...
	@Override
	public Sujet trouver(String nom) throws DAOException {
		...
		try {
			...
			preparedStatement = (PreparedStatement) DAOUtilitaire.initialisationRequetePreparee( connexion, SQL_SELECT_PAR_NOM, false, nom );
